/** Autonomous order fulfilment for HiveLog — GitHub Action on new issue.
...
comment(["✅ **Payment verified — your HiveLog Pro license:**", "", "Open HiveLog → **Pro** → *Have a key?* → paste:", "", "```", license, "```", "", "Lifetime, works offline. Thanks for supporting the bees 🐝"].join("\n"));
